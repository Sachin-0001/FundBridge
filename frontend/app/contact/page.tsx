    ...
    <div className="min-h-screen bg-[#0A0A0A] text-zinc-300 selection:bg-blue-500/30 pb-20">
      ...
      <div className="border-b border-zinc-800/50 bg-[#0A0A0A]/80 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="cursor-pointer flex items-center gap-2 text-zinc-400 hover:text-white transition-colors">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@fundbridge.ai" className="cursor-pointer text-sm text-zinc-400 hover:text-blue-400 transition-colors">support@fundbridge.ai</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:partners@fundbridge.ai" className="cursor-pointer text-sm text-zinc-400 hover:text-indigo-400 transition-colors">partners@fundbridge.ai</a>
                    </div>
                  </div>
            ...
            <div className="md:col-span-2">
              <form onSubmit={handleSubmit} className="p-8 bg-[#0F0F0F] border border-zinc-800/80 rounded-2xl space-y-6">
                ...
                <button
                  ...
                  className="cursor-pointer w-full bg-white text-black font-semibold py-3 rounded-xl hover:bg-zinc-200 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {status === 'loading' ? (
